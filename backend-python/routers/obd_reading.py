...
@router.post("/{car_id}/obd-readings", response_model=ObdReadingResponse)
def create_reading(
    car_id: str,
...
@router.get("/{car_id}/obd-readings/latest", response_model=Optional[ObdReadingResponse])
...
@router.get("/{car_id}/obd-readings", response_model=List[ObdReadingResponse])
def list_readings(
    car_id: str,
