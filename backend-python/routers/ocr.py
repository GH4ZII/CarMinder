...
from config.responses import AUTH_RESPONSES, BAD_REQUEST_RESPONSE, SERVER_ERROR_RESPONSE
...
@router.post(
    ...
    responses={**AUTH_RESPONSES, **BAD_REQUEST_RESPONSE, **SERVER_ERROR_RESPONSE},
)
